...
- [Search our issue
  tracker](https://github.com/manifoldco/go-connector/issues/search&type=issues)
  for your problem, someone may have already reported it

# Opening a Pull Request

To contribute, [fork](https://help.github.com/articles/fork-a-repo/)
`go-connector`, commit your changes, and [open a pull
...
Manifold's go-connector is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/go-connector), either for an
